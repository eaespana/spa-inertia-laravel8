                        ...
                        <div class="shadow bg-white md:rounded-md p-4">
                            <div class="flex justify-between">
                                <input 
                                    ...
                                    placeholder="Buscar..." 
                                    v-model="q">
                                <Link :href="route('notes.create')" class="bg-blue-500 text-white font-blod py-2 px-4 rounded-md">
                                 Crear
                                </Link>
                            </div>
                            <hr class="my-6">
                            <table>
                                <tr v-for="note in notes">
                                    ...
                                    <td class="border px4 py-2">
                                        <Link :href="route('notes.show', note. id)" class="bg-blue-500 text-white font-blod py-1 px-3 rounded-md">
                                        Mostrar
                                        </Link>
                                    </td>
                                    <td class="border px4 py-2">
                                        <Link :href="route('notes.edit', note. id)" class="bg-blue-500 text-white font-blod py-1 px-3 rounded-md">
                                        Editar
                                        </Link>
                                    </td>
                                </tr>
